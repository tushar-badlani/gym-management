...
public class query2 
{
	public static void create()
	{
		...
		try
		{
			Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","ashwat","passwordchahiye");
			Statement stat=conn.createStatement();
			ResultSet res=stat.executeQuery("select * from customer where name = 'Rohini' ");
			int i = 0;
			while(res.next()) 
			{
